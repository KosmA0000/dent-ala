// Wygenerowane automatycznie przez gen_data.cjs — nie edytuj recznie.
...
export const clinic = {
  ...
  "opisKrotki": "Niepubliczny Zakład Opieki Zdrowotnej \"Dent-Ala\" istnieje ponad 18 lat, jednak swe doświadczenie opiera na ponad pięćdziesięcioletniej działalności stomatologicznej w prywatnym gabinecie. Dbając o Państwa piękny uśmiech dokładamy wszelkich starań, aby zabiegi przebiegały bezboleśnie i w miłej atmosferze."
};
...
export const oNas = {
  ...
  "dokumentSrodowiskowy": {
    "tekst": "Informacja o wpływie działalności wykonywanej przez jednostkę organizacyjną na zdrowie ludzi i na środowisko w Irmina Gralec Niepubliczny Zakład Opieki Zdrowotnej \"Dent-Ala\":",
...
export const zakres = {
  "tytul": "Zakres usług",
  "lead": "Niepubliczny Zakład Opieki Zdrowotnej \"Dent-Ala\" realizuje usługi zarówno na podstawie umowy z Narodowym Funduszem Zdrowia jak i prywatne. W naszej ofercie znajdziecie Państwo między innymi specjalistyczne świadczenia z zakresu: ortodoncji, chirurgii stomatologicznej, pedodoncji, stomatologii zachowawczej, endodoncji, protetyki, stomatologii estetycznej oraz rentgenodiagnostyki stomatologicznej.",
  "kategorie": [
    {
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "podtytul": "Aparaty ruchome (wyjmowane):",
          "pozycje": [
